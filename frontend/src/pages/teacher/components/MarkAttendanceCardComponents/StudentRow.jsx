...
const StudentRow = ({
  ...
  // Mobile Card View - NO Table components
  if (isMobile) {
    return (
      <Card.Root
        w="full"
        ...
        <Card.Body p="4">
          <VStack spacing="3" align="stretch">
            ...
            <HStack justify="space-between" align="start">
              ...
              {/* Action Menu */}
              {attendanceData[student.id]?.status && mode !== "view" && (
                <Menu.Root>
  ...
  // Desktop Table Row - ONLY when isMobile is false
  return (
    <Table.Row
      bg={colorMode === "dark" ? "gray.800" : "white"}
      _hover={{
        ...
        <VStack align="start" spacing={2}>
          ...
          >
            <HStack spacing={2} flexWrap="wrap">
              <RadioCard.Item
                ...
                _hover={{
                  borderColor: "green.400",
                  bg: colorMode === "dark" ? "green.900" : "green.25",
                }}
              >
                <RadioCard.ItemHiddenInput />
                <RadioCard.ItemControl>
              ...
              <RadioCard.Item
                ...
                _hover={{
                  borderColor: "red.400",
                  bg: colorMode === "dark" ? "red.900" : "red.25",
                }}
              >
                <RadioCard.ItemHiddenInput />
                <RadioCard.ItemControl>
              ...
              <RadioCard.Item
                ...
                _hover={{
                  borderColor: "orange.400",
                  bg: colorMode === "dark" ? "orange.900" : "orange.25",
                }}
              >
                <RadioCard.ItemHiddenInput />
                <RadioCard.ItemControl>
              ...
              <RadioCard.Item
                ...
                _hover={{
                  borderColor: "blue.400",
                  bg: colorMode === "dark" ? "blue.900" : "blue.25",
                }}
              >
                <RadioCard.ItemHiddenInput />
                <RadioCard.ItemControl>
          ...
          {attendanceData[student.id]?.status && (
            ...
            >
              <HStack spacing={1}>
                {getStatusIcon(attendanceData[student.id].status)}
                <Text>{attendanceData[student.id].status}</Text>
              </HStack>
            </Badge>
          )}
        </VStack>
