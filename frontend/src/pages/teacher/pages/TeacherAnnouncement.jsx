          ...
          >
            <VStack align="start" spacing="1" flex="1" minW="0">
              <HStack spacing="2" wrap="wrap">
                <LuMegaphone color="#0d9488" size="20" />
                <Text
              ...
              >
                Create and manage academy, batch, and class announcements
              </Text>
            </VStack>
            <Button
              bg="#0d9488"
                      ...
                      >
                        <HStack spacing="2" w="full" align="start">
                          <Box
                            color={
                              colorMode === "dark"
                                ? `${getTypeColor(announcement.type)}.300`
                                : `${getTypeColor(announcement.type)}.500`
                            }
                            flexShrink="0"
                            mt="1"
                          >
